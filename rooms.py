...
gas_pockets = Room('gas pockets', 'basic pickaxe', 1,
                   'an area of weak stone. You can hear a hissing from '
                   + 'somewhere close. You can mine through the stone with '
                   + 'just a basic pickaxe. ')
abandoned_shaft = Room('abandoned shaft', 'basic pickaxe', 3,
                       'an old abandoned mineshaft. It appears deserted. ')
damp_cave = Room('damp_cave', 'basic pickaxe', 1, 'dimly lit cave. '
                + 'There are puddles in low spots and stalagtites and '
                + 'stalagmites extend from the ceiling and floor. ')
